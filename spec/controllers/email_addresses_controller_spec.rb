...
RSpec.describe EmailAddressesController, :type => :controller do
  ...
  describe "POST create" do
    describe "with valid params" do
      let(:contact) { Person.create(first_name: 'Steve', last_name: 'Smith') }
      let(:valid_attributes) { { address: 'test@test.com', contact_id: contact.id, contact_type: 'Person' } }
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      let(:valid_attributes) { { address: 'test@test.com', contact_id: bob.id, contact_type: 'Person' } }
      let(:new_attributes) {
        { address: "new@new.com", contact_id: bob.id, contact_type: 'Person' }
      }
      ...
      it "updates the requested email_address" do
        ...
        expect(email_address.address).to eql('new@new.com')
        expect(email_address.contact_id).to eql(bob.id)
      end
  ...
  describe "DELETE destroy" do
    let(:contact) { Person.create(first_name: 'Bob', last_name: 'Jones') }
    let(:valid_attributes) { { address: 'test@test.com', contact_id: contact.id, contact_type: 'Person' } }
