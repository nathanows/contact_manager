...
RSpec.describe PhoneNumbersController, :type => :controller do
  ...
  let(:valid_attributes) {
    {number: 'MyNumber', contact_id: 1, contact_type: 'Person'}
  }
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      let(:valid_attributes) { { number: '555-7777', contact_id: alice.id, contact_type: 'Person' } }
      ...
      it "redirects to the phone numbers's person" do
        alice = Person.create(first_name: 'Alice', last_name: 'Smith')
        valid_attributes = { number: '555-7777', contact_id: alice.id, contact_type: 'Person' }
        post :create, {:phone_number => valid_attributes}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      let(:new_attributes) {
        {number: 'MyNewNumber', contact_id: bob.id, contact_type: 'Person'}
      }
