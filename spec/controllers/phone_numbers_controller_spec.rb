...
RSpec.describe PhoneNumbersController, :type => :controller do
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      let(:valid_attributes) { { number: '555-7777', person_id: alice.id } }
      ...
      it "redirects to the phone numbers's person" do
        ...
        valid_attributes = { number: '555-7777', person_id: alice.id }
        post :create, {:phone_number => valid_attributes}, valid_session
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      let(:new_attributes) {
        {number: 'MyNewNumber', person_id: bob.id}
      }
